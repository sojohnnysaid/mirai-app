...
const (
	...
	UserServiceName = "mirai.v1.UserService"
)
...
const (
	...
	UserServiceGetMeProcedure = "/mirai.v1.UserService/GetMe"
...
func NewUserServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) UserServiceClient {
	...
	userServiceMethods := v1.File_mirai_v1_user_proto.Services().ByName("UserService").Methods()
...
// GetUser calls mirai.v1.UserService.GetUser.
...
// UpdateUser calls mirai.v1.UserService.UpdateUser.
...
func (UnimplementedUserServiceHandler) GetMe(context.Context, *connect.Request[v1.GetMeRequest]) (*connect.Response[v1.GetMeResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("mirai.v1.UserService.GetMe is not implemented"))
}
...
func (UnimplementedUserServiceHandler) GetUser(context.Context, *connect.Request[v1.GetUserRequest]) (*connect.Response[v1.GetUserResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("mirai.v1.UserService.GetUser is not implemented"))
}
